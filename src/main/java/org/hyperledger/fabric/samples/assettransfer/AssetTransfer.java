...
public final class AssetTransfer implements ContractInterface {
    ...
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String newAssetId, final String newOwner) {
        //get asset with asserID
        Asset oldAsset = ReadAsset(ctx, assetID);

        //create new asset with new owner
        Asset newAsset = CreateAsset(ctx, newAssetId, oldAsset.getColor(), oldAsset.getSize(), newOwner, oldAsset.getAppraisedValue());
